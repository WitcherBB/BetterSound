...
@OnlyIn(Dist.CLIENT)
public class PianoBlockScreen extends AbstractContainerScreen<PianoBlockMenu> {
    ...
    private final PianoBlockEntity blockEntity;
    ...
    public PianoBlockScreen(PianoBlockMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected class PianoKeyButton extends AbstractButton {
        ...
        private final PianoBlockScreen fatherInstance = PianoBlockScreen.this;
        ...
        public PianoKeyButton(KeyCategory keyCategory, int id) {
            super(0, PianoBlockScreen.this.topPos + 35, keyCategory == KeyCategory.WHITE ? 17 : 10, keyCategory == KeyCategory.WHITE ? 70 : 40, CommonComponents.GUI_DONE);
